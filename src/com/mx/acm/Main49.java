 ...
 * @author maoxin
 * 883049 ythyhvh 开心的小明 Accepted  234  16849 java 05-27 10:33:29 
 */
public class Main49 {
	...
	public static void main(String[] args) throws IOException {
		...
		while(total > 0)
		{
			...
			dp =  new int[nTotalType + 1][nTotalMoney + 1];
			...
			System.out.println(dp[nTotalType][nTotalMoney]);
			total--;
		}
